    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen w-full bg-gray-50 p-4 page-transition">
            <div className="mb-12 text-center animate-bounce-slow">
                <p className="text-lg font-medium text-gray-700 bg-white/50 backdrop-blur-sm px-6 py-3 rounded-full shadow-sm border border-white/30 glow-blue">
                    For the best experience, please view in <span className="text-blue-500 font-bold">full screen</span> ✨
                </p>
            </div>
